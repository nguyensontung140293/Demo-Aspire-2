using AspireApp.ApiService.Features.WeatherForecasts;
using AspireApp.ApiService.Features.WeatherForecasts.Create;
using AspireApp.ApiService.Features.WeatherForecasts.Delete;
using AspireApp.ApiService.Features.WeatherForecasts.GetAll;
using AspireApp.ApiService.Features.WeatherForecasts.GetById;
using AspireApp.ApiService.Features.WeatherForecasts.Update;
using MediatR;
